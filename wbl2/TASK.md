WB Tech: level \# 2 (Golang) Как делать задания Никаких устных решений
...
Определение функции: var or func(channels ...\<- chan interface{}) \<-
...
Реализовать HTTP-сервер для работы с календарем. В рамках задания
